...
def get_menu(day_ind):
    ...
    for menu in menus:
        title = menu.find("h2", {"class": "menu-title"}).getText() # get title => Spaghetti Bolognese
        description = menu.find("p", {"class": "menu-description"}).getText() # get description => Spaghetti mit einer Fleischsauce
        price = menu.findAll("span", {"class": "price"})[1].find("span", {"class": "val"}).getText() # get price => 10.50
